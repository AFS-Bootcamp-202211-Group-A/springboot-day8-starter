...
public class EmployeeControllerTest {
    ...
    @Test
    void should_delete_employee_when_perform_delete_given_employees_id() throws Exception {
        //given
        Employee oldBob = employeeRepository.create(new Employee(10, "Bob", 23, "Male", 5000));
        //when & should
        client.perform(MockMvcRequestBuilders.delete("/employees/{id}", oldBob.getId()))
